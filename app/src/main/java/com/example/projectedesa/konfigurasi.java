...
public class konfigurasi {
    ...
    public static final String URL_ADD="http://192.168.1.40/Android/pegawai/tambahPgw.php";
    public static final String URL_GET_ALL = "http://192.168.1.40/Android/pegawai/tampilSemuaPgw.php";
    public static final String URL_GET_EMP = "http://192.168.1.40/Android/pegawai/tampilPgw.php?id=";
    public static final String URL_UPDATE_EMP = "http://192.168.1.40/Android/pegawai/updatePgw.php";
    public static final String URL_DELETE_EMP = "http://192.168.1.40/Android/pegawai/hapusPgw.php?id=";
    ...
    public static final String KEY_PASSWORD_OLD = "password";
