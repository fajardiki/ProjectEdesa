...
public class konfigurasi {
    ...
    public static final String URL_ADD="http://192.168.100.26/Android/pegawai/tambahPgw.php";
    public static final String URL_GET_ALL = "http://192.168.100.26/Android/pegawai/tampilSemuaPgw.php";
    public static final String URL_GET_EMP = "http://192.168.100.26/Android/pegawai/tampilPgw.php?id=";
    public static final String URL_UPDATE_EMP = "http://192.168.100.26/Android/pegawai/updatePgw.php";
    public static final String URL_DELETE_EMP = "http://192.168.100.26/Android/pegawai/hapusPgw.php?id=";
    ...
    // URL DATABASE R DESA
    public static final String URL_PENGUMUMAN_ALL = "http://192.168.100.26/GitHub/ProjectWebService/api/C_pengumuman";
    public static final String URL_PERMOHONAN_ONE = "http://192.168.100.26/GitHub/ProjectWebService/api/c_permohonan/";
